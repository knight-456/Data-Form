    ...
    <div className={"space-y-5"}>
      <div className={"grid grid-cols-2 gap-5 p-5"}>
        ...
        <span className={"col-span-full md:col-span-1"}>
          {new Date(addProductDetail?.data?.startDate).toDateString()}
        </span>
        <span className={"col-span-full md:col-span-1"}>{"End Date:"}</span>
        <span className={"col-span-full md:col-span-1"}>
          {new Date(addProductDetail?.data?.endDate).toDateString()}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {"Production Per Day:"}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {addProductDetail?.data?.productionPerDayPerMachine || 0}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {"Total Order Quantity:"}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {addProductDetail?.data?.totalOrderQuantity || 0}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {"Is China Fabric Present"}
        </span>
        <span className={"col-span-full md:col-span-1"}>
          {addProductDetail?.data?.isChinaFabricPresent ? "Yes" : "No"}
        </span>
